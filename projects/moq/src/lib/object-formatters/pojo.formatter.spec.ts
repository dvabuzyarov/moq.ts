...
describe("Pojo formatter", () => {

    beforeEach(() => {
        createInjector(PojoFormatter, [StaticInjector]);
    });
    ...
    it("Returns formatted value", () => {
        ...
        const objectFormatter = new Mock<ObjectFormatter>()
            .setup(instance => instance.format(number.toString()))
            .returns("1")
        ...
        const matcher = resolve2(PojoFormatter);
    ...
    it("Returns undefined for unsupported types", () => {
        const provider = resolve2(PojoFormatter);
