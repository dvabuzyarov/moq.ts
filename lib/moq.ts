...
export interface IMock<T> {
     ...
     * .setup(instance => It.Is((expression: ExpectedNamedMethodExpression) => expression.name === 'test' && expression.arguments[0] === 1))
     *
     * //setting propertyA to value of 'a'
     * .setup(instance => {instance.propertyA = 'a'})
     * ```
     * @param expression A function that accepts a [Proxy](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy)
     ...
     *
     * @returns {@link ISetup} for the provided expression.
     */
     ...
     * @deprecated
     * @obsolete
     * Use custom setup as described ["How to throw an exception on missed setup?"](https://github.com/dvabuzyarov/moq.ts/wiki/How-to-throw-an-exception-on-missed-setup%3F).
